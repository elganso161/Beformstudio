...
let objJson = [
  ...
  {
    title: "5ESSENCE 4.0",
    subtitle: "Shoe store chain",
    link: "./project-page-5essence-4.0-en.html",
    img: "./img/6-projects-main/desctop/img-12-desctop.jpg",
    imgX2: "./img/6-projects-main/desctop/img-12-desctop-x2.jpg",
    imgW: "./img/6-projects-main/desctop/img-12-desctop.webp",
    imgWx2: "./img/6-projects-main/desctop/img-12-desctop-x2.webp",
    imgfull: "./img/6-projects-main/full/img-12-full.jpg",
    imgfullX2: "./img/6-projects-main/full/img-12-full-x2.jpg",
    imgfullW: "./img/6-projects-main/full/img-12-full.webp",
    imgfullWx2: "./img/6-projects-main/full/img-12-full-x2.webp",
    img1024: "./img/6-projects-main/1024px/img-12-1024.jpg",
    img1024X2: "./img/6-projects-main/1024px/img-12-1024-x2.jpg",
    img1024W: "./img/6-projects-main/1024px/img-12-1024.webp",
    img1024Wx2: "./img/6-projects-main/1024px/img-12-1024-x2.webp",
    imgtab: "./img/6-projects-main/tab/img-12-tab.jpg",
    imgtabX2: "./img/6-projects-main/tab/img-12-tab-x2.jpg",
    imgtabW: "./img/6-projects-main/tab/img-12-tab.webp",
    imgtabWx2: "./img/6-projects-main/tab/img-12-tab-x2.webp",
    imgmob: "./img/6-projects-main/mob/img-12-mob.jpg",
    imgmobX2: "./img/6-projects-main/mob/img-12-mob-x2.jpg",
    imgmobW: "./img/6-projects-main/mob/img-12-mob.webp",
    imgmobWx2: "./img/6-projects-main/mob/img-12-mob-x2.webp",
  },
  {
    title: "Fluffy&Puffy",
    subtitle: "Upholstered furniture showroom",
    ...
    imgW: "./img/6-projects-main/desctop/img-11-desctop.webp",
    imgWx2: "./img/6-projects-main/desctop/img-11-desctop-x2.webp",
    imgfull: "./img/6-projects-main/full/img-11-full.jpg",
    imgfullX2: "./img/6-projects-main/full/img-11-full-x2.jpg",
    imgfullW: "./img/6-projects-main/full/img-11-full.webp",
    imgfullWx2: "./img/6-projects-main/full/img-11-full-x2.webp",
    img1024: "./img/6-projects-main/1024px/img-11-1024.jpg",
    img1024X2: "./img/6-projects-main/1024px/img-11-1024-x2.jpg",
    img1024W: "./img/6-projects-main/1024px/img-11-1024.webp",
    img1024Wx2: "./img/6-projects-main/1024px/img-11-1024-x2.webp",
    imgtab: "./img/6-projects-main/tab/img-11-tab.jpg",
    imgtabX2: "./img/6-projects-main/tab/img-11-tab-x2.jpg",
    imgtabW: "./img/6-projects-main/tab/img-11-tab.webp",
    imgtabWx2: "./img/6-projects-main/tab/img-11-tab-x2.webp",
    imgmob: "./img/6-projects-main/mob/img-11-mob.jpg",
    imgmobX2: "./img/6-projects-main/mob/img-11-mob-x2.jpg",
    imgmobW: "./img/6-projects-main/mob/img-11-mob.webp",
    imgmobWx2: "./img/6-projects-main/mob/img-11-mob-x2.webp",
  },
  {
    title: "umecos",
  ...
  },
  {
    title: "5ESSENCE 3.0",
    subtitle: "Shoe store chain",
    link: "./project-page-5essence-3.0-en.html",
  ...
  },
  {
    title: "5ESSENCE 2.0",
    subtitle: "Shoe store chain",
    link: "./project-page-5essence-2.0-en.html",
  ...
  },
  {
    title: "5ESSENCE 1.0",
    subtitle: "Shoe store chain",
    link: "./project-page-5essence-1.0-en.html",
    ...
    listing_table.innerHTML += `<li class="project__list-item">
      <div class="project__list-item-title-en">
        ...
        <div>
          ...
          <a href="${objJson[i].link}">View project</a>
        </div>
      </div>
